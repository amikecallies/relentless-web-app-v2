...
<i>"." ".$p_message. " <b>Please respond to ".$p_name." at the following contact information: </b>".$p_email."/".$p_phone."</i>";
...
if(!$mail->send()) {
    ...
    echo "Email sent succesfully!";//header("Location: ../form-submit.html");
}
?>
